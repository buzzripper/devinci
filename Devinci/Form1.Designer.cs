namespace Devinci
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			btnCopy.Location = new Point(569, 207);
			...
			txtDecodedToken.Size = new Size(593, 477);
